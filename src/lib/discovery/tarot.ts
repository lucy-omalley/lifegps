import type { TarotCard, TarotSpreadType } from "@/types/discovery";
...
export function drawTarotCards(spreadType: TarotSpreadType): TarotCard[] {
...
export function getSpreadLabel(spreadType: TarotSpreadType): string {
  switch (spreadType) {
    case "single":
      return "1 Card — Quick Reflection";
    case "three-card":
      return "3 Cards — Past / Present / Future";
    case "five-card":
      return "5 Cards — Situation / Challenge / Advice / Hidden Factor / Next Step";
  }
}
